...
export const CVView = ({ commandInput, setCommandInput, handleKeyDown, commandHistory }) => {
  return (
    <div className="min-h-screen bg-vscode-bg text-vscode-fg font-mono text-sm">
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="no-print mb-6 border-b border-vscode-border pb-4">
          <WindowControls path="~/portfolio/cv" />
        </div>
        ...
        <div className="mt-8 max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-vscode-fg leading-relaxed">
              {cvData.summary}
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            {cvData.experience.map((exp, idx) => (
              <div key={idx} className="mb-6 pl-4 border-l-2 border-vscode-border">
                <div className="mb-2">
